...
nohup python train_distillation_student.py --early_stop --epoch_num 100  --phase_num 2 --early_stop_num 20 --gradual_unfrozen > training_logs/train_cnn_distillation_phase2_log.txt 2>&1 &
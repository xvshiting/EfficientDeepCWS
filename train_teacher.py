...
import time 
from cws_models import CWSRoberta
import os 
...
parser.add_argument("--model_name", type=str, default="CWSRoberta")
...
config.cls_hidden_dim = 768
config.label_num = 5
config.classifier_dropout = 0.1
config.model_name = model_name

model = CWSRoberta(config)
model.encoder.load_state_dict(pretrained_model.bert.state_dict())
model.to(device)
